				...
				<div class="layui-form-item">
					<div class="layui-input-inline">
						<input type="text" name="username" id="keywords"
							placeholder="请输入工号或姓名" autocomplete="off" class="layui-input" value="${param.keywords}">
					</div>
				...
				success : function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						content += "<tr><td>" + li + "</td><td>" + data[i].account + "</td><td>" + data[i].name + "</td><td>" + data[i].tel + "</td><td>" +
							...
							data[i].id + "><i class='layui-icon'>&#xe642;</i>修改</a></a></td></tr>";
					}
					if (content == "") {
				...
				$.ajax({
					...
					success : function(data) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							content += "<tr><td>" + li + "</td><td>" + data[i].myname + "</td><td>" + data[i].name + "</td><td>" + data[i].tel + "</td><td>" +
								user + "</td><td>" + car + "</td><td>" + pact + "</td><td>" + complain + "</td><td><a href=http://localhost:8080/public-usermodify/jsp/super-admin-edit.jsp?id=" +
								data[i].id + ">修改</a></td></tr>";
						}
						$("#content").html(content);
					}
